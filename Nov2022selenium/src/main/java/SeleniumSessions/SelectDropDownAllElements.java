...
//		}
		...
		public static void selectDropDownValue(By locator, String expValue) { //this method is used when you don't have these 3 option to select the option of drop down
			List<WebElement> optionsList = getDropDownOptionsList(locator);
			for(WebElement e : optionsList) {
				String text = e.getText();
				System.out.println(text);
